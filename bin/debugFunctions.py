...
TODO = {
    '1.14': [
            ...
            'Doc: bin.programs',
            'Unload: bin.application',
            'Unload: bin.audioWaveform',
            'Doc: bin.constants',
            'Doc: bin.crashHandler',
            'Doc: bin.dataManagement',
            'Doc: bin.decorators',
            'Doc: bin.gui',
            'Doc: bin.letsplayfile',
            'Doc: bin.log',
            'Doc: bin.minfuncs',
            'Doc: bin.obsObserver',
            'Doc: bin.resolvePipe',
            'Doc: runtimeSettingsRI',
            'Doc: bin.settings',
            'Doc: bin.thumbnailGenerator',
            'Doc: bin.tree',
            'Doc: bin.ui_elements',
            'Rem: bin.update'
    ],
